...
/**
 * This is the model class for table "weixin_pay".
 *
 ...
 */
class WeixinPay extends \yii\db\ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('out_trade_no','checkOutTradeNo'),
	...
	{
		if(WeixinPay::model()->exists("out_trade_no=:out_trade_no",array(":out_trade_no"=>$this->out_trade_no)))
		{
			$this->addError('out_trade_no','该订单号已存在!');
		}
	}
